...
class BasePageVC: BaseViewController, JXSegmentedViewDelegate {
...
extension BasePageVC: JXPagingViewDelegate {
...
extension BasePageVC: JXPagingMainTableViewGestureDelegate {
