...
class PieChartView: UIControl {
    ...
    override init(frame: CGRect) {
        ...
        self.pieModelArray = [
            ...
            PieModel(angle: totalPi * 0.1, alpha: 0.9, desc: "第二个弧形"),
            PieModel(angle: totalPi * 0.1, alpha: 0.8, desc: "第三个弧形"),
            PieModel(angle: totalPi * 0.1, alpha: 1, desc: "第四个弧形"),
            PieModel(angle: totalPi * 0.3, alpha: 0.5, desc: "第五个弧形"),
        ]
        self.drawPieChart()
    }
